...
/* harmony export */   "rand_bin32_base64": () => (/* binding */ rand_bin32_base64),
/* harmony export */   "rand_bin32_hex": () => (/* binding */ rand_bin32_hex)
/* harmony export */ });
...
* @returns {any}
*/
function rand_bin32_base64() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.rand_bin32_base64(retptr);
...
* @returns {any}
*/
function rand_bin32_hex() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.rand_bin32_hex(retptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL(/* asset import */ __webpack_require__(12), __webpack_require__.b);
    }
    const imports = getImports();
...
module.exports = __webpack_require__.p + "57e34d37e21468ba105c.wasm";
